...
connections <- rbind(partner_congregations, activity_congregations)
...
edge_information <- pivot_longer(connections, cols = starts_with("congregation"), names_to = "congregation", values_to = "specific_congregation")
...
network_layout <- layout.circle(G)
